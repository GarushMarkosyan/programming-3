    ...
    die() {
        if (this.energy <= 0) {
            ...
            for (var i in grassEaterOgnoxArr) {
                if (grassEaterOgnoxArr[i].x == this.x && grassEaterOgnoxArr[i].y == this.y) {
                    grassEaterOgnoxArr.splice(i, 1)
                }
            }
        }
    }
    ...
    eat() {
        ...
        if (food) {
            ...
            if (matrix[newY][newX] == 1) {
                ...
                matrix[this.y][this.x] = 0
                for (var i in grassEaterOgnoxArr) {
                    if (grassEaterOgnoxArr[i].x == newX && grassEaterOgnoxArr[i].y == newY) {
                        grassEaterOgnoxArr.splice(i, 1)
                    }
                }
            }
